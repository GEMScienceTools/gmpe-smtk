...
filepath="../file_samples/ASA/correct_ASA_files"
instance=ASADatabaseMetadataReader(db_id='1',
                                   db_name='db',
                                   filename=filepath,
                                   record_folder=filepath)
database=instance.parse()
...
class ASA_MetadataParsertest(unittest.TestCase):
    ...
    def test_event_id(self):
        ...
        self.assertEqual(parsed_evt_ids, ['1989-03-10_05:19:51',
            '2010-04-04_22:40:04'])
    ...
    def test_morphology(self):
        ...
        self.assertEqual(parsed_morphology, ['ARENA - LIMO - ARCILLA  ',
