...
#DATA = os.path.abspath('') #for running test in notebook from smtk/parsers/tests
#BASE_DATA_PATH = os.path.join(DATA,"data") #for running test in notebook from smtk/parsers/tests

BASE_DATA_PATH = os.path.join(os.path.dirname(__file__), "data") #for running test in console from smtk/parsers/tests
